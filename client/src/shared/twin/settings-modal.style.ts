...
export const styles = {
  upload: [
    tw`w-px-170 h-px-36 tracking-tight bg-blue-600 text-[${slate_50}] rounded-md hover:bg-blue-800 ease-in-out duration-150`
  ],
  remove: [
    tw`w-px-170 border h-px-36 tracking-tight text-[${slate_900}] rounded-md ease-in-out duration-150`
  ],
