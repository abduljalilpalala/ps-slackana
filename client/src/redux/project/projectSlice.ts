...
export const addNewTeam = createAsyncThunk('project/addNewTeamStatus', async (_, thunkAPI) => {
  const { project }: any = thunkAPI.getState()
...
export const removeTeam = createAsyncThunk('project/removeTeamStatus', async (_, thunkAPI) => {
  const { project }: any = thunkAPI.getState()
...
export const updateProjectRepo = createAsyncThunk(
  'project/updateProjectRepo',
  async (repoData: any, thunkAPI) => {
...
export const projectSlice = createSlice({
  ...
  extraReducers: (builder: ActionReducerMapBuilder<any>) => {
    builder
      ...
      // Update Project Repo
      .addCase(updateProjectRepo.pending, (state) => {
        state.isRepoLoading = true
      })
      .addCase(updateProjectRepo.fulfilled, (state) => {
      ...
      .addCase(updateProjectRepo.rejected, (state, action: PayloadAction<any>) => {
        state.isError = true
        state.isSuccess = false
        state.isRepoLoading = false
        state.error = action.payload
