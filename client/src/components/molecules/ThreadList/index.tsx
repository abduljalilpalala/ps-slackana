...
const ThreadList: FC<Props> = (props): JSX.Element => {
  const {
    isOpenThread,
    actions: { handleOpenThread }
  } = props

  return (
    <div className="flex flex-col">
      <section className="flex items-start space-x-2 px-6 py-2 transition duration-75 ease-in-out">
      ...
      <Divider />
      <section className="group-message relative isolate flex items-start space-x-2 px-6 py-2 transition duration-75 ease-in-out hover:bg-slate-100">
        <header className="flex-shrink-0">
          <img
